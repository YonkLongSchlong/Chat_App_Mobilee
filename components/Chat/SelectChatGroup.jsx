...
import { View, Text, TextInput, StyleSheet, FlatList, TouchableOpacity, Image, Button, Pressable } from 'react-native';
...
const SelectChatGroup = () => {
        ...
        >
            ...
            <TouchableOpacity
                style={[styles.checkboxContainer, {
                    backgroundColor: selectedFriends.includes(item._id) ? '#007AFF' : 'transparent',
                }]}
                onPress={() => handleCheckBoxChange(item._id)}
            >
    ...
    const createGroup = async () => {
        if (selectedFriends.length > 1 && groupName.trim() !== '') {
          try {
            ...
            const response = await useFetchCreateGroup(user, token, selectedFriends, groupName);
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.selectedFriendList}>
                {selectedFriendItems}
            </View>
